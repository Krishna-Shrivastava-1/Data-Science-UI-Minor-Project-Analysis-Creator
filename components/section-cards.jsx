...
export function SectionCards({summa}) {
  return (
    <div
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
        {summa?.summary?.rows || summa?.summary?.rows_after}
          </CardTitle>
          {/* <CardAction>
            <Badge variant="outline">
              <IconTrendingDown />
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            {summa?.summary?.duplicate_rows || 0}
          </CardTitle>
          {/* <CardAction>
            <Badge variant="outline">
              <IconTrendingUp />
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
           {summa?.summary?.missing_values || 0}
          </CardTitle>
          {/* <CardAction>
            <Badge variant="outline">
              <IconTrendingUp />
