...
const Page = () => {
  ...
  return (
    <div>
      <h1 className='text-center font-bold text-4xl m-4'>Anvisul</h1>
      <p className='text-center text-muted-foreground'>An DataScience project to analyze any csv data and visualize it as well directly without repeating same preprocessing process over the data manually.</p>
